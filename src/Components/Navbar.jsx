...
export default function Navbar() {
  ...
  return (
    ...
    <div
      ...
      className={
        scrolnav == true
          ? "  text-gray-800 fixed w-full bg-gray-100 justify-between items-center flex h-[80px] px-4"
          : " text-gray-300 fixed w-full bg-gray-800 justify-between items-center flex h-[80px] px-4"
      }
    >
     ...
     */}
      <ul className=" hidden md:flex text-2xl   ">
        <li className=" hover:text-lime-300 hover:border-b-4 border-lime-300">
