...
export default function Work() {
 ...
 <div 
      ...
      >
        ...
        <div className=" md:w-[389%] hidden md:flex flex-col justify-center items-center duration-300 rounded-md effect opacity-0 hover:opacity-100 ">
          <span className="font-bold mb-[50px] text-2xl">Chat Application </span>
          <div className="grid grid-cols-2 gap-5">
            <a href="/">
              <button className=" p-[15px] w-[100px] rounded-md bg-gray-800 font-bold ">Demo</button>
            </a>
            <a href="/">
              <button  className=" p-[15px] bg-gray-800 w-[100px] rounded-md font-bold" >Code</button>
            </a>
          </div>
        </div>
      </div>
 <div 
      ...
      >
         ...
         */}
        <div className=" md:w-[389%] hidden md:flex flex-col justify-center items-center duration-300 rounded-md effect opacity-0 hover:opacity-100 ">
          <span className="font-bold mb-[50px] text-2xl">Medical Website </span>
          <div className="grid grid-cols-2 gap-5">
            <a href="/">
              <button className=" p-[15px] w-[100px] rounded-md bg-gray-800 font-bold ">Demo</button>
            </a>
 ...
 <div 
      ...
      >
         ...
         */}
        <div className=" md:w-[389%] hidden md:flex flex-col justify-center items-center duration-300 rounded-md effect opacity-0 hover:opacity-100 ">
          <span className="font-bold mb-[50px] text-2xl">E-commerce Website </span>
          <div className="grid grid-cols-2 gap-5">
            <a href="/">
              <button className=" p-[15px] w-[100px] rounded-md bg-gray-800 font-bold ">Demo</button>
            </a>
